...
import { towardVec3 } from '../util/Math';

const DEFAULT_ACCELERATION = 1.29 * 60;
const DEFAULT_DECELERATION = 1.29 * 100;
...
export class CharacterStatus extends cc.Component {
    ...
    public update (deltaTime: number) {
        ...
        towardVec3(
            velocity,
            targetVelocity,
            cc.math.Vec3.multiplyScalar(new cc.math.Vec3(), 
                targetVelocity.lengthSqr() < velocity.lengthSqr() ? deceleration : acceleration, deltaTime),
            velocity,
        );
    ...
    private _deceleration = new cc.math.Vec3(DEFAULT_DECELERATION, DEFAULT_DECELERATION, DEFAULT_DECELERATION);
